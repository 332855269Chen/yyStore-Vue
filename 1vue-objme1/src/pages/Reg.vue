  ...
  <div class="content">
    ...
    <div class="login-box">
      ...
      <div class="login">
        ...
        <span></span>
        <router-link to="/reg" style="background:#fe846d;">注册</router-link>
      </div>
      <p class="rsolid"></p>
    </div>
    <ul>
      <li class="lifirst">
        <input type="text" v-model="ipt3"/>
        <span>帐号</span>
      </li>
      <li>
...
export default {
  ...
  methods:{
    reg(){
        ...
        formdata.append("username",this.ipt3)
        formdata.append("password",this.ipt4)
